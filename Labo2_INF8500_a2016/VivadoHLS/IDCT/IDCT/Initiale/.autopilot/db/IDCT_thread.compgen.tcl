...
set id 1
set name IDCT_mul_32s_15ns_32_3
...
set id 3
set name IDCT_mul_32s_14ns_32_3
set corename simcore_mul
set op mul
set stage_num 3
set registered_input 1
...
set id 12
set name IDCT_mul_32s_12ns_32_3
set corename simcore_mul
set op mul
set stage_num 3
set registered_input 1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ReadEnablePort_0 { O 1 vector } ReadEnablePort_0_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WriteEnablePort_0 { O 1 vector } WriteEnablePort_0_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WriteDataPort_0 { O 32 vector } WriteDataPort_0_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ReadEnablePort_1 { O 1 vector } ReadEnablePort_1_ap_vld { O 1 bit } } \
} "
}
