...
#ifndef _IDCT_thread_in_H_
#define _IDCT_thread_in_H_
...
struct IDCT_thread_in_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(IDCT_thread_in_core);
    IDCT_thread_in_core(sc_core::sc_module_name) {
        SC_METHOD(proc_di);
        sensitive << d;
...
SC_MODULE( IDCT_thread_in )
{
    ...
    SC_CTOR( IDCT_thread_in ) {
        meminst = new IDCT_thread_in_core <1, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    IDCT_thread_in_core <1, 2, DataWidth, AddressWidth, AddressRange>* meminst;
