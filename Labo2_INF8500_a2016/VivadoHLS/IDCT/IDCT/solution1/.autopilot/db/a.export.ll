...
entry:
  ...
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [7 x i8]* @p_str2, [11 x i8]* @p_str3, i32 0, i32 0, i1* %nResetPort) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [7 x i8]* @p_str2, [10 x i8]* @p_str4, i32 0, i32 0, i1* %ClockPort) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 1, [18 x i8]* @p_str5, [17 x i8]* @p_str6, i32 0, i32 0, i1* %ReadEnablePort_0) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [18 x i8]* @p_str5, [16 x i8]* @p_str7, i32 0, i32 0, i1* %ReadEmptyPort_0) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [19 x i8]* @p_str8, [15 x i8]* @p_str9, i32 0, i32 0, i32* %ReadDataPort_0) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 1, [18 x i8]* @p_str5, [18 x i8]* @p_str10, i32 0, i32 0, i1* %WriteEnablePort_0) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [18 x i8]* @p_str5, [16 x i8]* @p_str11, i32 0, i32 0, i1* %WriteFullPort_0) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 1, [19 x i8]* @p_str8, [16 x i8]* @p_str12, i32 0, i32 0, i32* %WriteDataPort_0) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 1, [18 x i8]* @p_str5, [17 x i8]* @p_str13, i32 0, i32 0, i1* %ReadEnablePort_1) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [18 x i8]* @p_str5, [16 x i8]* @p_str14, i32 0, i32 0, i1* %ReadEmptyPort_1) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [19 x i8]* @p_str8, [15 x i8]* @p_str15, i32 0, i32 0, i32* %ReadDataPort_1) nounwind
  call void (...)* @_ssdm_op_SpecProcessDef([5 x i8]* @p_str1, i32 2, [7 x i8]* @p_str16) nounwind
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str17) nounwind ; <i32> [#uses=1]
  ...
  call void @_ssdm_op_WireWrite.volatile.i1P(i1* %ReadEnablePort_1, i1 false) nounwind
  ...
  %empty_19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str17, i32 %tmp_1) nounwind ; <i32> [#uses=0]
  %Yc_addr_9 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 0 ; <i32*> [#uses=2]
  %Yc_addr = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 4 ; <i32*> [#uses=2]
  %Yc_addr_1 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 6 ; <i32*> [#uses=2]
  %Yc_addr_2 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 2 ; <i32*> [#uses=2]
  %Yc_addr_3 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 1 ; <i32*> [#uses=2]
  %Yc_addr_4 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 7 ; <i32*> [#uses=2]
  %Yc_addr_5 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 3 ; <i32*> [#uses=2]
  %Yc_addr_6 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 5 ; <i32*> [#uses=2]
...
bb5.i:                                            ; preds = %bb11.i, %bb.i65.i
  ...
  br i1 %tmp_V, label %bb.i65.i, label %bb7.i
...
bb11.i:                                           ; preds = %bb7.i, %bb
  ...
  %indvar_next1 = xor i1 %indvar1, true           ; <i1> [#uses=1]
  br i1 %indvar1, label %ModuleRead_1.exit, label %bb5.i

ModuleRead_1.exit:                                ; preds = %bb11.i
  %uiCommand_load = load i32* %uiCommand          ; <i32> [#uses=1]
  %tmp_4 = icmp eq i32 %uiCommand_load, 1         ; <i1> [#uses=1]
  br i1 %tmp_4, label %bb1, label %bb2
...
bb5.i34:                                          ; preds = %bb11.i43, %bb.i65.i33
  ...
  br i1 %tmp_V_2, label %bb.i65.i33, label %bb7.i36
...
bb11.i43:                                         ; preds = %bb7.i36, %bb1
  ...
  %indvar_next = xor i1 %indvar, true             ; <i1> [#uses=1]
  br i1 %indvar, label %bb2, label %bb5.i34

bb2:                                              ; preds = %bb11.i43, %ModuleRead_1.exit
  %uiCommand_load_1 = load i32* %uiCommand        ; <i32> [#uses=1]
  %tmp_8 = icmp eq i32 %uiCommand_load_1, 2       ; <i1> [#uses=1]
  br i1 %tmp_8, label %bb23.preheader, label %bb
...
bb4:                                              ; preds = %bb23
  %val_V_4_0 = call i1 @_ssdm_op_WireRead.volatile.i1P(i1* %ReadEmptyPort_1) nounwind ; <i1> [#uses=0]
  br label %bb9.i58
...
bb5.i54:                                          ; preds = %bb9.i58, %bb.i93.i
  %tmp_V_4 = call i1 @_ssdm_op_WireRead.volatile.i1P(i1* %ReadEmptyPort_1) nounwind ; <i1> [#uses=1]
  br i1 %tmp_V_4, label %bb.i93.i, label %bb7.i55

bb7.i55:                                          ; preds = %bb5.i54
  %val_V_2 = call i32 @_ssdm_op_WireRead.volatile.i32P(i32* %ReadDataPort_1) nounwind ; <i32> [#uses=2]
  %tmp_5 = trunc i32 %val_V_2 to i16              ; <i16> [#uses=1]
  store i16 %tmp_5, i16* %in_addr_1, align 2
  %in_addr_2 = getelementptr inbounds [64 x i16]* %in, i32 0, i32 %ptData3_0_sum238241_i_cast ; <i16*> [#uses=1]
  %p_Result_1 = call i16 @_ssdm_op_PartSelect.i16.i32.i32.i32(i32 %val_V_2, i32 16, i32 31) ; <i16> [#uses=1]
  store i16 %p_Result_1, i16* %in_addr_2, align 2
  call void @_ssdm_op_WireWrite.volatile.i1P(i1* %ReadEnablePort_1, i1 true) nounwind
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind
  call void @_ssdm_op_WireWrite.volatile.i1P(i1* %ReadEnablePort_1, i1 false) nounwind
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind
  br label %bb9.i58
...
bb9.i58:                                          ; preds = %bb7.i55, %bb4
  ...
  %i_4_cast = zext i6 %i to i7                    ; <i7> [#uses=1]
  %ptData3_0_rec_i = shl i7 %i_4_cast, 1          ; <i7> [#uses=1]
  %ptData3_0_rec_i_cast = zext i7 %ptData3_0_rec_i to i32 ; <i32> [#uses=1]
  %ptData3_0_sum238241_i = call i7 @_ssdm_op_PartSet.i7.i7.i6.i32.i32(i7 1, i6 %i, i32 1, i32 6) ; <i7> [#uses=1]
  %ptData3_0_sum238241_i_cast = zext i7 %ptData3_0_sum238241_i to i32 ; <i32> [#uses=1]
  ...
  %exitcond1 = icmp eq i6 %i, -32                 ; <i1> [#uses=1]
  %i_1 = add i6 %i, 1                             ; <i6> [#uses=1]
  br i1 %exitcond1, label %bb9, label %bb5.i54

bb6:                                              ; preds = %bb7
  %tmp_49 = add i6 %column_1_cast, %tmp_2         ; <i6> [#uses=1]
  %tmp_49_cast = zext i6 %tmp_49 to i32           ; <i32> [#uses=2]
  %in_addr = getelementptr inbounds [64 x i16]* %in, i32 0, i32 %tmp_49_cast ; <i16*> [#uses=1]
  %in_load = load i16* %in_addr, align 2          ; <i16> [#uses=1]
  %tmp_50_cast = zext i16 %in_load to i19         ; <i19> [#uses=1]
  %tmp_51 = shl i19 %tmp_50_cast, 3               ; <i19> [#uses=1]
  %tmp_51_cast = sext i19 %tmp_51 to i32          ; <i32> [#uses=1]
  %Y_addr_7 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %tmp_49_cast ; <i32*> [#uses=1]
  store i32 %tmp_51_cast, i32* %Y_addr_7, align 4
  br label %bb7
...
bb7:                                              ; preds = %bb7.preheader, %bb6
  ...
  %exitcond5 = icmp eq i4 %column_1, -8           ; <i1> [#uses=1]
  %column_2 = add i4 %column_1, 1                 ; <i4> [#uses=1]
  br i1 %exitcond5, label %bb8, label %bb6

bb8:                                              ; preds = %bb7
  %Y_addr_9 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %tmp_2_cast ; <i32*> [#uses=2]
  %Y_load_2 = load i32* %Y_addr_9, align 4        ; <i32> [#uses=2]
  %tmp_73 = trunc i6 %row_cast to i3              ; <i3> [#uses=1]
  %p_sum = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 4, i3 %tmp_73, i32 3, i32 5) ; <i6> [#uses=1]
  %p_sum_cast = zext i6 %p_sum to i32             ; <i32> [#uses=1]
  %Y_addr = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %p_sum_cast ; <i32*> [#uses=2]
  %Y_load = load i32* %Y_addr, align 4            ; <i32> [#uses=2]
  %z1_1 = sub nsw i32 %Y_load_2, %Y_load          ; <i32> [#uses=2]
  %z1_0 = add nsw i32 %Y_load, %Y_load_2          ; <i32> [#uses=2]
  %tmp_74 = trunc i6 %row_cast to i3              ; <i3> [#uses=1]
  %p_sum1 = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 6, i3 %tmp_74, i32 3, i32 5) ; <i6> [#uses=1]
  %p_sum1_cast = zext i6 %p_sum1 to i32           ; <i32> [#uses=1]
  %Y_addr_1 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %p_sum1_cast ; <i32*> [#uses=2]
  %Y_load_7 = load i32* %Y_addr_1, align 4        ; <i32> [#uses=2]
  %tmp_75 = trunc i6 %row_cast to i3              ; <i3> [#uses=1]
  %p_sum2 = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 2, i3 %tmp_75, i32 3, i32 5) ; <i6> [#uses=1]
  %p_sum2_cast = zext i6 %p_sum2 to i32           ; <i32> [#uses=1]
  %Y_addr_2 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %p_sum2_cast ; <i32*> [#uses=2]
  %Y_load_8 = load i32* %Y_addr_2, align 4        ; <i32> [#uses=2]
  %tmp_9 = mul nsw i32 %Y_load_8, 8867            ; <i32> [#uses=1]
  %tmp_s = mul nsw i32 %Y_load_7, 21407           ; <i32> [#uses=1]
  %tmp_3 = sub nsw i32 %tmp_9, %tmp_s             ; <i32> [#uses=1]
  %tmp_76 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_3, i32 14, i32 31) ; <i18> [#uses=1]
  %z1_2 = sext i18 %tmp_76 to i32                 ; <i32> [#uses=2]
  %tmp_10 = mul nsw i32 %Y_load_8, 21407          ; <i32> [#uses=1]
  %tmp_11 = mul nsw i32 %Y_load_7, 8867           ; <i32> [#uses=1]
  %tmp_12 = add nsw i32 %tmp_11, %tmp_10          ; <i32> [#uses=1]
  %tmp_77 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_12, i32 14, i32 31) ; <i18> [#uses=1]
  %z1_3 = sext i18 %tmp_77 to i32                 ; <i32> [#uses=2]
  %tmp_78 = trunc i6 %row_cast to i3              ; <i3> [#uses=1]
  %p_sum3 = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 1, i3 %tmp_78, i32 3, i32 5) ; <i6> [#uses=1]
  %p_sum3_cast = zext i6 %p_sum3 to i32           ; <i32> [#uses=1]
  %Y_addr_3 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %p_sum3_cast ; <i32*> [#uses=2]
  %Y_load_3 = load i32* %Y_addr_3, align 4        ; <i32> [#uses=2]
  %tmp_79 = trunc i6 %row_cast to i3              ; <i3> [#uses=1]
  %p_sum4 = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 7, i3 %tmp_79, i32 3, i32 5) ; <i6> [#uses=1]
  %p_sum4_cast = zext i6 %p_sum4 to i32           ; <i32> [#uses=1]
  %Y_addr_4 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %p_sum4_cast ; <i32*> [#uses=2]
  %Y_load_4 = load i32* %Y_addr_4, align 4        ; <i32> [#uses=2]
  %z1_4 = sub nsw i32 %Y_load_3, %Y_load_4        ; <i32> [#uses=2]
  %z1_7 = add nsw i32 %Y_load_4, %Y_load_3        ; <i32> [#uses=2]
  %tmp_80 = trunc i6 %row_cast to i3              ; <i3> [#uses=1]
  %p_sum5 = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 3, i3 %tmp_80, i32 3, i32 5) ; <i6> [#uses=1]
  %p_sum5_cast = zext i6 %p_sum5 to i32           ; <i32> [#uses=1]
  %Y_addr_5 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %p_sum5_cast ; <i32*> [#uses=2]
  %Y_load_5 = load i32* %Y_addr_5, align 4        ; <i32> [#uses=1]
  %tmp_17 = mul nsw i32 %Y_load_5, 23170          ; <i32> [#uses=1]
  %tmp_81 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_17, i32 14, i32 31) ; <i18> [#uses=1]
  %z1_5 = sext i18 %tmp_81 to i32                 ; <i32> [#uses=2]
  %tmp_82 = trunc i6 %row_cast to i3              ; <i3> [#uses=1]
  %p_sum6 = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 5, i3 %tmp_82, i32 3, i32 5) ; <i6> [#uses=1]
  %p_sum6_cast = zext i6 %p_sum6 to i32           ; <i32> [#uses=1]
  %Y_addr_6 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %p_sum6_cast ; <i32*> [#uses=2]
  %Y_load_6 = load i32* %Y_addr_6, align 4        ; <i32> [#uses=1]
  %tmp_19 = mul nsw i32 %Y_load_6, 23170          ; <i32> [#uses=1]
  %tmp_83 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_19, i32 14, i32 31) ; <i18> [#uses=1]
  %z1_6 = sext i18 %tmp_83 to i32                 ; <i32> [#uses=2]
  %z3_3 = sub nsw i32 %z1_0, %z1_3                ; <i32> [#uses=2]
  %z3_0 = add nsw i32 %z1_0, %z1_3                ; <i32> [#uses=2]
  %z3_2 = sub nsw i32 %z1_1, %z1_2                ; <i32> [#uses=2]
  %z3_1 = add nsw i32 %z1_1, %z1_2                ; <i32> [#uses=2]
  %y_assign_2 = sub nsw i32 %z1_4, %z1_6          ; <i32> [#uses=2]
  %x_assign_1 = add nsw i32 %z1_4, %z1_6          ; <i32> [#uses=2]
  %x_assign_2 = sub nsw i32 %z1_7, %z1_5          ; <i32> [#uses=2]
  %y_assign_1 = add nsw i32 %z1_7, %z1_5          ; <i32> [#uses=2]
  %tmp_25 = mul nsw i32 %x_assign_1, 13623        ; <i32> [#uses=1]
  %tmp_26 = mul nsw i32 %y_assign_1, 9102         ; <i32> [#uses=1]
  %tmp_27 = sub nsw i32 %tmp_25, %tmp_26          ; <i32> [#uses=1]
  %tmp_84 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_27, i32 14, i32 31) ; <i18> [#uses=1]
  %z3_4 = sext i18 %tmp_84 to i32                 ; <i32> [#uses=2]
  %tmp_29 = mul nsw i32 %x_assign_1, 9102         ; <i32> [#uses=1]
  %tmp_30 = mul nsw i32 %y_assign_1, 13623        ; <i32> [#uses=1]
  %tmp_31 = add nsw i32 %tmp_30, %tmp_29          ; <i32> [#uses=1]
  %tmp_85 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_31, i32 14, i32 31) ; <i18> [#uses=1]
  %z3_7 = sext i18 %tmp_85 to i32                 ; <i32> [#uses=2]
  %tmp_33 = mul nsw i32 %x_assign_2, 16069        ; <i32> [#uses=1]
  %tmp_34 = mul nsw i32 %y_assign_2, 3196         ; <i32> [#uses=1]
  %tmp_35 = sub nsw i32 %tmp_33, %tmp_34          ; <i32> [#uses=1]
  %tmp_86 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_35, i32 14, i32 31) ; <i18> [#uses=1]
  %z3_5 = sext i18 %tmp_86 to i32                 ; <i32> [#uses=2]
  %tmp_37 = mul nsw i32 %x_assign_2, 3196         ; <i32> [#uses=1]
  %tmp_38 = mul nsw i32 %y_assign_2, 16069        ; <i32> [#uses=1]
  %tmp_39 = add nsw i32 %tmp_38, %tmp_37          ; <i32> [#uses=1]
  %tmp_88 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_39, i32 14, i32 31) ; <i18> [#uses=1]
  %z3_6 = sext i18 %tmp_88 to i32                 ; <i32> [#uses=2]
  %tmp_41 = sub nsw i32 %z3_0, %z3_7              ; <i32> [#uses=1]
  store i32 %tmp_41, i32* %Y_addr_4, align 4
  %tmp_42 = add nsw i32 %z3_0, %z3_7              ; <i32> [#uses=1]
  store i32 %tmp_42, i32* %Y_addr_9, align 4
  %tmp_43 = sub nsw i32 %z3_1, %z3_6              ; <i32> [#uses=1]
  store i32 %tmp_43, i32* %Y_addr_1, align 4
  %tmp_44 = add nsw i32 %z3_1, %z3_6              ; <i32> [#uses=1]
  store i32 %tmp_44, i32* %Y_addr_3, align 4
  %tmp_45 = sub nsw i32 %z3_2, %z3_5              ; <i32> [#uses=1]
  store i32 %tmp_45, i32* %Y_addr_6, align 4
  %tmp_46 = add nsw i32 %z3_2, %z3_5              ; <i32> [#uses=1]
  store i32 %tmp_46, i32* %Y_addr_2, align 4
  %tmp_47 = sub nsw i32 %z3_3, %z3_4              ; <i32> [#uses=1]
  store i32 %tmp_47, i32* %Y_addr, align 4
  %tmp_48 = add nsw i32 %z3_3, %z3_4              ; <i32> [#uses=1]
  store i32 %tmp_48, i32* %Y_addr_5, align 4
  br label %bb9
...
bb9:                                              ; preds = %bb9.i58, %bb8
  ...
  %exitcond2 = icmp eq i4 %row, -8                ; <i1> [#uses=1]
  %row_3 = add i4 %row, 1                         ; <i4> [#uses=1]
  br i1 %exitcond2, label %bb21, label %bb7.preheader

bb7.preheader:                                    ; preds = %bb9
  %tmp_2 = shl i6 %row_cast, 3                    ; <i6> [#uses=2]
  %tmp_2_cast = zext i6 %tmp_2 to i32             ; <i32> [#uses=1]
  br label %bb7

bb12:                                             ; preds = %bb13
  %tmp_71 = shl i6 %row_1_cast1, 3                ; <i6> [#uses=1]
  %tmp_72 = add i6 %tmp_71, %column_cast          ; <i6> [#uses=1]
  %tmp_97_cast = zext i6 %tmp_72 to i32           ; <i32> [#uses=1]
  %Y_addr_8 = getelementptr inbounds [64 x i32]* %Y, i32 0, i32 %tmp_97_cast ; <i32*> [#uses=1]
  %Y_load_1 = load i32* %Y_addr_8, align 4        ; <i32> [#uses=1]
  %Yc_addr_7 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 %row_1_cast ; <i32*> [#uses=1]
  store i32 %Y_load_1, i32* %Yc_addr_7, align 4
  br label %bb13
...
bb13:                                             ; preds = %bb21, %bb12
  ...
  %exitcond4 = icmp eq i4 %row_1, -8              ; <i1> [#uses=1]
  %row_4 = add i4 %row_1, 1                       ; <i4> [#uses=1]
  br i1 %exitcond4, label %bb14, label %bb12

bb14:                                             ; preds = %bb13
  %Yc_load_1 = load i32* %Yc_addr_9, align 4      ; <i32> [#uses=2]
  %Yc_load = load i32* %Yc_addr, align 4          ; <i32> [#uses=2]
  %z1_1_1 = sub nsw i32 %Yc_load_1, %Yc_load      ; <i32> [#uses=2]
  %z1_0_1 = add nsw i32 %Yc_load, %Yc_load_1      ; <i32> [#uses=2]
  %Yc_load_2 = load i32* %Yc_addr_1, align 4      ; <i32> [#uses=2]
  %Yc_load_8 = load i32* %Yc_addr_2, align 4      ; <i32> [#uses=2]
  %tmp_6 = mul nsw i32 %Yc_load_8, 8867           ; <i32> [#uses=1]
  %tmp_7 = mul nsw i32 %Yc_load_2, 21407          ; <i32> [#uses=1]
  %tmp_13 = sub nsw i32 %tmp_6, %tmp_7            ; <i32> [#uses=1]
  %tmp_14 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_13, i32 14, i32 31) ; <i18> [#uses=1]
  %z1_2_1 = sext i18 %tmp_14 to i32               ; <i32> [#uses=2]
  %tmp_15 = mul nsw i32 %Yc_load_8, 21407         ; <i32> [#uses=1]
  %tmp_16 = mul nsw i32 %Yc_load_2, 8867          ; <i32> [#uses=1]
  %tmp_18 = add nsw i32 %tmp_16, %tmp_15          ; <i32> [#uses=1]
  %tmp_20 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_18, i32 14, i32 31) ; <i18> [#uses=1]
  %z1_3_1 = sext i18 %tmp_20 to i32               ; <i32> [#uses=2]
  %Yc_load_3 = load i32* %Yc_addr_3, align 4      ; <i32> [#uses=2]
  %Yc_load_4 = load i32* %Yc_addr_4, align 4      ; <i32> [#uses=2]
  %z1_4_1 = sub nsw i32 %Yc_load_3, %Yc_load_4    ; <i32> [#uses=2]
  %z1_7_1 = add nsw i32 %Yc_load_4, %Yc_load_3    ; <i32> [#uses=2]
  %Yc_load_5 = load i32* %Yc_addr_5, align 4      ; <i32> [#uses=1]
  %tmp_21 = mul nsw i32 %Yc_load_5, 23170         ; <i32> [#uses=1]
  %tmp_22 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_21, i32 14, i32 31) ; <i18> [#uses=1]
  %z1_5_1 = sext i18 %tmp_22 to i32               ; <i32> [#uses=2]
  %Yc_load_6 = load i32* %Yc_addr_6, align 4      ; <i32> [#uses=1]
  %tmp_23 = mul nsw i32 %Yc_load_6, 23170         ; <i32> [#uses=1]
  %tmp_24 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_23, i32 14, i32 31) ; <i18> [#uses=1]
  %z1_6_1 = sext i18 %tmp_24 to i32               ; <i32> [#uses=2]
  %z3_3_1 = sub nsw i32 %z1_0_1, %z1_3_1          ; <i32> [#uses=2]
  %z3_0_1 = add nsw i32 %z1_0_1, %z1_3_1          ; <i32> [#uses=2]
  %z3_2_1 = sub nsw i32 %z1_1_1, %z1_2_1          ; <i32> [#uses=2]
  %z3_1_1 = add nsw i32 %z1_1_1, %z1_2_1          ; <i32> [#uses=2]
  %y_assign_5 = sub nsw i32 %z1_4_1, %z1_6_1      ; <i32> [#uses=2]
  %x_assign_4 = add nsw i32 %z1_4_1, %z1_6_1      ; <i32> [#uses=2]
  %x_assign_5 = sub nsw i32 %z1_7_1, %z1_5_1      ; <i32> [#uses=2]
  %y_assign_4 = add nsw i32 %z1_7_1, %z1_5_1      ; <i32> [#uses=2]
  %tmp_28 = mul nsw i32 %x_assign_4, 13623        ; <i32> [#uses=1]
  %tmp_32 = mul nsw i32 %y_assign_4, 9102         ; <i32> [#uses=1]
  %tmp_36 = sub nsw i32 %tmp_28, %tmp_32          ; <i32> [#uses=1]
  %tmp_40 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_36, i32 14, i32 31) ; <i18> [#uses=1]
  %z3_4_1 = sext i18 %tmp_40 to i32               ; <i32> [#uses=2]
  %tmp_50 = mul nsw i32 %x_assign_4, 9102         ; <i32> [#uses=1]
  %tmp_52 = mul nsw i32 %y_assign_4, 13623        ; <i32> [#uses=1]
  %tmp_53 = add nsw i32 %tmp_52, %tmp_50          ; <i32> [#uses=1]
  %tmp_54 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_53, i32 14, i32 31) ; <i18> [#uses=1]
  %z3_7_1 = sext i18 %tmp_54 to i32               ; <i32> [#uses=2]
  %tmp_55 = mul nsw i32 %x_assign_5, 16069        ; <i32> [#uses=1]
  %tmp_56 = mul nsw i32 %y_assign_5, 3196         ; <i32> [#uses=1]
  %tmp_57 = sub nsw i32 %tmp_55, %tmp_56          ; <i32> [#uses=1]
  %tmp_58 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_57, i32 14, i32 31) ; <i18> [#uses=1]
  %z3_5_1 = sext i18 %tmp_58 to i32               ; <i32> [#uses=2]
  %tmp_59 = mul nsw i32 %x_assign_5, 3196         ; <i32> [#uses=1]
  %tmp_60 = mul nsw i32 %y_assign_5, 16069        ; <i32> [#uses=1]
  %tmp_61 = add nsw i32 %tmp_60, %tmp_59          ; <i32> [#uses=1]
  %tmp_62 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_61, i32 14, i32 31) ; <i18> [#uses=1]
  %z3_6_1 = sext i18 %tmp_62 to i32               ; <i32> [#uses=2]
  %tmp_63 = sub nsw i32 %z3_0_1, %z3_7_1          ; <i32> [#uses=1]
  store i32 %tmp_63, i32* %Yc_addr_4, align 4
  %tmp_64 = add nsw i32 %z3_0_1, %z3_7_1          ; <i32> [#uses=1]
  store i32 %tmp_64, i32* %Yc_addr_9, align 4
  %tmp_65 = sub nsw i32 %z3_1_1, %z3_6_1          ; <i32> [#uses=1]
  store i32 %tmp_65, i32* %Yc_addr_1, align 4
  %tmp_66 = add nsw i32 %z3_1_1, %z3_6_1          ; <i32> [#uses=1]
  store i32 %tmp_66, i32* %Yc_addr_3, align 4
  %tmp_67 = sub nsw i32 %z3_2_1, %z3_5_1          ; <i32> [#uses=1]
  store i32 %tmp_67, i32* %Yc_addr_6, align 4
  %tmp_68 = add nsw i32 %z3_2_1, %z3_5_1          ; <i32> [#uses=1]
  store i32 %tmp_68, i32* %Yc_addr_2, align 4
  %tmp_69 = sub nsw i32 %z3_3_1, %z3_4_1          ; <i32> [#uses=1]
  store i32 %tmp_69, i32* %Yc_addr, align 4
  %tmp_70 = add nsw i32 %z3_3_1, %z3_4_1          ; <i32> [#uses=1]
  store i32 %tmp_70, i32* %Yc_addr_5, align 4
  br label %bb19

bb15_ifconv:                                      ; preds = %bb19
  %Yc_addr_8 = getelementptr inbounds [8 x i32]* %Yc, i32 0, i32 %row_2_cast1 ; <i32*> [#uses=1]
  %Yc_load_7 = load i32* %Yc_addr_8, align 4      ; <i32> [#uses=2]
  %tmp_89 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %Yc_load_7, i32 31) ; <i1> [#uses=1]
  %p_lobit_neg_cast = sext i1 %tmp_89 to i6       ; <i6> [#uses=1]
  %tmp = xor i6 %p_lobit_neg_cast, -32            ; <i6> [#uses=1]
  %tmp_cast = zext i6 %tmp to i32                 ; <i32> [#uses=1]
  %tmp_90 = add i32 %tmp_cast, %Yc_load_7         ; <i32> [#uses=1]
  %tmp_91 = call i26 @_ssdm_op_PartSelect.i26.i32.i32.i32(i32 %tmp_90, i32 6, i32 31) ; <i26> [#uses=1]
  %tmp_102_cast = sext i26 %tmp_91 to i27         ; <i27> [#uses=1]
  %r = add i27 %tmp_102_cast, 128                 ; <i27> [#uses=3]
  %tmp_92 = icmp sgt i27 %r, 0                    ; <i1> [#uses=1]
  %tmp_93 = call i19 @_ssdm_op_PartSelect.i19.i27.i32.i32(i27 %r, i32 8, i32 26) ; <i19> [#uses=1]
  %icmp = icmp slt i19 %tmp_93, 1                 ; <i1> [#uses=1]
  %tmp_94 = trunc i27 %r to i8                    ; <i8> [#uses=1]
  %phitmp = select i1 %icmp, i8 %tmp_94, i8 -1    ; <i8> [#uses=1]
  %iftmp_s = select i1 %tmp_92, i8 %phitmp, i8 0  ; <i8> [#uses=1]
  %tmp_95 = shl i6 %row_2_cast, 3                 ; <i6> [#uses=1]
  %tmp_96 = add i6 %tmp_95, %column_cast          ; <i6> [#uses=1]
  %tmp_107_cast = zext i6 %tmp_96 to i32          ; <i32> [#uses=1]
  %Idct_addr = getelementptr inbounds [64 x i8]* %Idct, i32 0, i32 %tmp_107_cast ; <i8*> [#uses=1]
  store i8 %iftmp_s, i8* %Idct_addr, align 1
  br label %bb19
...
bb19:                                             ; preds = %bb15_ifconv, %bb14
  ...
  %exitcond7 = icmp eq i4 %row_2, -8              ; <i1> [#uses=1]
  %row_5 = add i4 %row_2, 1                       ; <i4> [#uses=1]
  br i1 %exitcond7, label %bb21, label %bb15_ifconv
...
bb21:                                             ; preds = %bb19, %bb9
  ...
  %exitcond3 = icmp eq i4 %column, -8             ; <i1> [#uses=1]
  %column_3 = add i4 %column, 1                   ; <i4> [#uses=1]
  br i1 %exitcond3, label %bb22, label %bb13

bb22:                                             ; preds = %bb21
  %val_V_6_0 = call i1 @_ssdm_op_WireRead.volatile.i1P(i1* %WriteFullPort_0) nounwind ; <i1> [#uses=0]
  br label %bb8.i
...
bb5.i66:                                          ; preds = %bb8.i, %bb.i166.i
  %tmp_V_6 = call i1 @_ssdm_op_WireRead.volatile.i1P(i1* %WriteFullPort_0) nounwind ; <i1> [#uses=1]
  br i1 %tmp_V_6, label %bb.i166.i, label %bb7.i67

bb7.i67:                                          ; preds = %bb5.i66
  %Idct_load = load i8* %Idct_addr_4, align 1     ; <i8> [#uses=1]
  %p_Result_s = zext i8 %Idct_load to i32         ; <i32> [#uses=1]
  %Idct_load_1 = load i8* %Idct_addr_3, align 1   ; <i8> [#uses=1]
  %Idct_load_2 = load i8* %Idct_addr_2, align 1   ; <i8> [#uses=1]
  %Idct_load_3 = load i8* %Idct_addr_1, align 1   ; <i8> [#uses=1]
  %tmp_87 = call i24 @_ssdm_op_BitConcatenate.i24.i8.i8.i8(i8 %Idct_load_3, i8 %Idct_load_2, i8 %Idct_load_1) ; <i24> [#uses=1]
  %p_Result_2 = call i32 @_ssdm_op_PartSet.i32.i32.i24.i32.i32(i32 %p_Result_s, i24 %tmp_87, i32 8, i32 31) ; <i32> [#uses=1]
  call void @_ssdm_op_WireWrite.volatile.i32P(i32* %WriteDataPort_0, i32 %p_Result_2) nounwind
...
bb8.i:                                            ; preds = %bb7.i67, %bb22
  ...
  %Idct_addr_1 = getelementptr [64 x i8]* %Idct, i32 0, i32 %tmp332338_i_cast ; <i8*> [#uses=1]
  ...
  %Idct_addr_2 = getelementptr [64 x i8]* %Idct, i32 0, i32 %tmp333339_i_cast ; <i8*> [#uses=1]
  ...
  %Idct_addr_3 = getelementptr [64 x i8]* %Idct, i32 0, i32 %tmp335340_i_cast ; <i8*> [#uses=1]
  %Idct_addr_4 = getelementptr [64 x i8]* %Idct, i32 0, i32 %tmp_i_cast ; <i8*> [#uses=1]
  %empty_28 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) nounwind ; <i32> [#uses=0]
  %exitcond6 = icmp eq i5 %i_2, -16               ; <i1> [#uses=1]
  %i_3 = add i5 %i_2, 1                           ; <i5> [#uses=1]
  br i1 %exitcond6, label %bb23, label %bb5.i66

bb23:                                             ; preds = %bb8.i, %bb23.preheader
  %block = phi i32 [ 0, %bb23.preheader ], [ %block_1, %bb8.i ] ; <i32> [#uses=2]
  %exitcond = icmp eq i32 %block, %tmp1           ; <i1> [#uses=1]
  %block_1 = add i32 %block, 1                    ; <i32> [#uses=1]
  br i1 %exitcond, label %bb, label %bb4
}
...
entry:
  call void (...)* @_ssdm_op_SpecTopModule([5 x i8]* @p_str1, [5 x i8]* @p_str1) nounwind
  %IDCT_ssdm_thread_M_thread_load = load i1* @IDCT_ssdm_thread_M_thread, align 1 ; <i1> [#uses=1]
  br i1 %IDCT_ssdm_thread_M_thread_load, label %bb, label %bb1

bb:                                               ; preds = %entry
  call void @"IDCT::thread"(i1* %nResetPort, i1* %ClockPort, i1* %ReadEnablePort_0, i1* %ReadEmptyPort_0, i32* %ReadDataPort_0, i1* %WriteEnablePort_0, i1* %WriteFullPort_0, i32* %WriteDataPort_0, i1* %ReadEnablePort_1, i1* %ReadEmptyPort_1, i32* %ReadDataPort_1)
  unreachable

bb1:                                              ; preds = %entry
  call void (...)* @_ssdm_op_SpecProcessDecl([5 x i8]* @p_str1, i32 2, [7 x i8]* @p_str16) nounwind
  call void (...)* @_ssdm_op_SpecSensitive([7 x i8]* @p_str16, [10 x i8]* @p_str4, i1* %ClockPort, i32 1) nounwind
  call void (...)* @_ssdm_op_SpecSensitive([7 x i8]* @p_str16, [11 x i8]* @p_str3, i1* %nResetPort, i32 3) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [7 x i8]* @p_str2, [11 x i8]* @p_str3, i32 0, i32 0, i1* %nResetPort) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [7 x i8]* @p_str2, [10 x i8]* @p_str4, i32 0, i32 0, i1* %ClockPort) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 1, [18 x i8]* @p_str5, [17 x i8]* @p_str6, i32 0, i32 0, i1* %ReadEnablePort_0) nounwind
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str1, i32 0, [18 x i8]* @p_str5, [16 x i8]* @p_str7, i32 0, i32 0, i1* %ReadEmptyPort_0) nounwind
