...
#ifndef _IDCT_thread_Idct_H_
#define _IDCT_thread_Idct_H_
...
struct IDCT_thread_Idct_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(IDCT_thread_Idct_core);
    IDCT_thread_Idct_core(sc_core::sc_module_name) {
        SC_METHOD(proc_di);
        sensitive << d;
...
SC_MODULE( IDCT_thread_Idct )
{
    ...
    SC_CTOR( IDCT_thread_Idct ) {
        meminst = new IDCT_thread_Idct_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    IDCT_thread_Idct_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
