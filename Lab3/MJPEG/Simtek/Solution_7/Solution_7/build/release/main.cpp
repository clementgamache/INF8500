...
int sc_main(int arg_count, char **arg_value){
	...
	TFSlaveAdapter S_TFSlaveAdapter6("S_TFSlaveAdapter6", 10, SC_NS, ISSADAPTER1_ID, false);
	TFSlaveAdapter S_TFSlaveAdapter7("S_TFSlaveAdapter7", 10, SC_NS, SIMULATION_TIMER_ID, false);
	TFSlaveAdapter S_TFSlaveAdapter8("S_TFSlaveAdapter8", 10, SC_NS, DEBUGMODULE1_ID, false);
	...
	adap_IDCT1_AMBA_AXIBus_LT1_wrIF.FifoIFPort[1](fifo_adap_IDCT1_AMBA_AXIBus_LT1_wrIF1.FifoIFExport);
	...
	S_TFSlaveAdapter6.SlaveIFPort(ISSAdapter1);
	S_TFSlaveAdapter7.SlaveIFPort(simulation_timer1);
	S_TFSlaveAdapter8.SlaveIFPort(DebugModule1);
	...
	XilinxPIC1.IRQInPort[6](sISSAdapter1_FIFO_4_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[7](sISSAdapter1_FIFO_5_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[8](sISSAdapter1_FIFO_3_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[9](sISSAdapter1_FIFO_6_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[10](sfifo_adap_IDCT1_AMBA_AXIBus_LT1_wrIF1_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[11](sISSAdapter1_FIFO_4_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[12](sISSAdapter1_FIFO_7_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[13](sfifo_adap_IDCT1_AMBA_AXIBus_LT1_rdIF0_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[14](sISSAdapter1_FIFO_1_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[15](sISSAdapter1_FIFO_5_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[16](sISSAdapter1_FIFO_7_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[17](sISSAdapter1_FIFO_2_IRQHasDataOutPort0);
