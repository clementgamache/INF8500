...
#define PIC_BASE_ADDRESS 0x41003000
...
#define STDOUT_BASE_ADDRESS 0x41002000
unsigned long m_stdout_address = STDOUT_BASE_ADDRESS;
#define STDIN_BASE_ADDRESS 0x41002000
...
const unsigned long m_semaphore_count = 19;
__attribute__ ((aligned (8))) unsigned char m_stacks[0];
void* m_semaphores[19];
EntryClass m_class_entries[7];
