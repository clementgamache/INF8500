...
int sc_main(int arg_count, char **arg_value){
	...
	TFSlaveAdapter S_TFSlaveAdapter4("S_TFSlaveAdapter4", 10, SC_NS, ISSADAPTER1_ID, false);
	TFSlaveAdapter S_TFSlaveAdapter5("S_TFSlaveAdapter5", 10, SC_NS, SIMULATION_TIMER_ID, false);
	TFSlaveAdapter S_TFSlaveAdapter6("S_TFSlaveAdapter6", 10, SC_NS, DEBUGMODULE1_ID, false);
	...
	ISSAdapterFIFO ISSAdapter1_FIFO_10("ISSAdapter1_FIFO_10", ISSADAPTER1_FIFO_10_ID, 64, false);
	...
	ISSAdapterFIFO ISSAdapter1_FIFO_6("ISSAdapter1_FIFO_6", ISSADAPTER1_FIFO_6_ID, 64, false);
	ISSAdapterFIFO ISSAdapter1_FIFO_7("ISSAdapter1_FIFO_7", ISSADAPTER1_FIFO_7_ID, 64, false);
	ISSAdapterFIFO ISSAdapter1_FIFO_8("ISSAdapter1_FIFO_8", ISSADAPTER1_FIFO_8_ID, 64, false);
	ISSAdapterFIFO ISSAdapter1_FIFO_9("ISSAdapter1_FIFO_9", ISSADAPTER1_FIFO_9_ID, 64, false);
	...
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_10_IRQHasDataOutPort0;
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_10_IRQHasRoomOutPort0;
	...
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_6_IRQHasDataOutPort0;
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_6_IRQHasRoomOutPort0;
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_7_IRQHasDataOutPort0;
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_7_IRQHasRoomOutPort0;
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_8_IRQHasDataOutPort0;
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_8_IRQHasRoomOutPort0;
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_9_IRQHasDataOutPort0;
	sc_core::sc_signal< bool > sISSAdapter1_FIFO_9_IRQHasRoomOutPort0;
	...
	ISSAdapter1.ReadFifoIFPort[6](ISSAdapter1_FIFO_6.ReadFifoIFExport);
	ISSAdapter1.ReadFifoIFPort[7](ISSAdapter1_FIFO_7.ReadFifoIFExport);
	ISSAdapter1.ReadFifoIFPort[8](ISSAdapter1_FIFO_8.ReadFifoIFExport);
	ISSAdapter1.ReadFifoIFPort[9](ISSAdapter1_FIFO_9.ReadFifoIFExport);
	ISSAdapter1.ReadFifoIFPort[10](ISSAdapter1_FIFO_10.ReadFifoIFExport);
	...
	ISSAdapter1.WriteFifoIFPort[6](ISSAdapter1_FIFO_6.WriteFifoIFExport);
	ISSAdapter1.WriteFifoIFPort[7](ISSAdapter1_FIFO_7.WriteFifoIFExport);
	ISSAdapter1.WriteFifoIFPort[8](ISSAdapter1_FIFO_8.WriteFifoIFExport);
	ISSAdapter1.WriteFifoIFPort[9](ISSAdapter1_FIFO_9.WriteFifoIFExport);
	ISSAdapter1.WriteFifoIFPort[10](ISSAdapter1_FIFO_10.WriteFifoIFExport);
	...
	S_TFSlaveAdapter4.SlaveIFPort(ISSAdapter1);
	S_TFSlaveAdapter5.SlaveIFPort(simulation_timer1);
	S_TFSlaveAdapter6.SlaveIFPort(DebugModule1);
	...
	ISSAdapter1_FIFO_6.IRQHasDataOutPort(sISSAdapter1_FIFO_6_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_4.IRQHasDataOutPort(sISSAdapter1_FIFO_4_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_7.IRQHasDataOutPort(sISSAdapter1_FIFO_7_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_8.IRQHasRoomOutPort(sISSAdapter1_FIFO_8_IRQHasRoomOutPort0);
	ISSAdapter1_FIFO_3.IRQHasDataOutPort(sISSAdapter1_FIFO_3_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_9.IRQHasDataOutPort(sISSAdapter1_FIFO_9_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_7.IRQHasRoomOutPort(sISSAdapter1_FIFO_7_IRQHasRoomOutPort0);
	ISSAdapter1_FIFO_5.IRQHasDataOutPort(sISSAdapter1_FIFO_5_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_10.IRQHasRoomOutPort(sISSAdapter1_FIFO_10_IRQHasRoomOutPort0);
	ISSAdapter1_FIFO_8.IRQHasDataOutPort(sISSAdapter1_FIFO_8_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_1.IRQHasRoomOutPort(sISSAdapter1_FIFO_1_IRQHasRoomOutPort0);
	ISSAdapter1_FIFO_6.IRQHasRoomOutPort(sISSAdapter1_FIFO_6_IRQHasRoomOutPort0);
	ISSAdapter1_FIFO_10.IRQHasDataOutPort(sISSAdapter1_FIFO_10_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_2.IRQHasDataOutPort(sISSAdapter1_FIFO_2_IRQHasDataOutPort0);
	ISSAdapter1_FIFO_9.IRQHasRoomOutPort(sISSAdapter1_FIFO_9_IRQHasRoomOutPort0);
	...
	ISSAdapter1_FIFO_6.nResetPort(reset_signal);
	ISSAdapter1_FIFO_7.nResetPort(reset_signal);
	ISSAdapter1_FIFO_8.nResetPort(reset_signal);
	ISSAdapter1_FIFO_9.nResetPort(reset_signal);
	ISSAdapter1_FIFO_10.nResetPort(reset_signal);
	...
	XilinxPIC1.IRQInPort[4](sISSAdapter1_FIFO_3_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[5](sISSAdapter1_FIFO_4_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[6](sISSAdapter1_FIFO_5_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[7](sISSAdapter1_FIFO_6_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[8](sISSAdapter1_FIFO_4_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[9](sISSAdapter1_FIFO_7_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[10](sISSAdapter1_FIFO_8_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[11](sISSAdapter1_FIFO_3_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[12](sISSAdapter1_FIFO_9_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[13](sISSAdapter1_FIFO_7_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[14](sISSAdapter1_FIFO_5_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[15](sISSAdapter1_FIFO_10_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[16](sISSAdapter1_FIFO_8_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[17](sISSAdapter1_FIFO_1_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[18](sISSAdapter1_FIFO_6_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[19](sISSAdapter1_FIFO_10_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[20](sISSAdapter1_FIFO_2_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[21](sISSAdapter1_FIFO_9_IRQHasRoomOutPort0);
	...
	ISSAdapter1_FIFO_6.attach(&engine);
	ISSAdapter1_FIFO_7.attach(&engine);
	ISSAdapter1_FIFO_8.attach(&engine);
	ISSAdapter1_FIFO_9.attach(&engine);
	ISSAdapter1_FIFO_10.attach(&engine);
