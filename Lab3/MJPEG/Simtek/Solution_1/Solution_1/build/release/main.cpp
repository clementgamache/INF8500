...
int sc_main(int arg_count, char **arg_value){
	...
	TFSlaveAdapter S_TFSlaveAdapter7("S_TFSlaveAdapter7", 10, SC_NS, VLD_ID, false);
	...
	ModuleSlaveAdapter adap_VLD1_AMBA_AXIBus_LT1_wrIF("adap_VLD1_AMBA_AXIBus_LT1_wrIF", VLD_ID, false);
	...
	SDLRegister DL_VLD1_TO_IQZZ1_SDLRegister1("DL_VLD1_TO_IQZZ1_SDLRegister1", DL_VLD1_TO_IQZZ1_SDLREGISTER1_ID, 64, false);
	...
	ModuleSlaveAdapterFIFOWrite fifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0("fifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0", FIFO_ADAP_VLD1_AMBA_AXIBUS_LT1_WRIF0_ID, 64, false);
	...
	sc_core::sc_signal< bool > sfifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0_IRQHasRoomOutPort0;
	...
	IQZZ1.SpaceModuleReadIFPort[1](DL_VLD1_TO_IQZZ1_SDLRegister1.SpaceModuleReadIFExport);
	IQZZ1.SpaceModuleWriteIFPort[0](DL_IQZZ1_TO_IDCT1_SDLRegister1.SpaceModuleWriteIFExport);
	VLD1.SpaceModuleReadIFPort[0](fifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0.SpaceModuleReadIFExport);
	VLD1.SpaceModuleWriteIFPort[0](DL_VLD1_TO_IQZZ1_SDLRegister1.SpaceModuleWriteIFExport);
	...
	adap_VLD1_AMBA_AXIBus_LT1_wrIF.FifoIFPort[0](fifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0.FifoIFExport);
	...
	S_TFSlaveAdapter7.SlaveIFPort(adap_VLD1_AMBA_AXIBus_LT1_wrIF);
	...
	fifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0.IRQHasRoomOutPort(sfifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0_IRQHasRoomOutPort0);
	...
	DL_VLD1_TO_IQZZ1_SDLRegister1.nResetPort(reset_signal);
	...
	fifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0.nResetPort(reset_signal);
	...
	XilinxPIC1.IRQInPort[3](sfifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0_IRQHasRoomOutPort0);
	...
	XilinxPIC1.IRQInPort[6](sISSAdapter1_FIFO_2_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[7](sISSAdapter1_FIFO_3_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[8](sISSAdapter1_FIFO_2_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[9](sISSAdapter1_FIFO_4_IRQHasRoomOutPort0);
	...
	XilinxPIC1.IRQInPort[12](sISSAdapter1_FIFO_3_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[13](sISSAdapter1_FIFO_4_IRQHasDataOutPort0);
	...
	DL_VLD1_TO_IQZZ1_SDLRegister1.attach(&engine);
	...
	fifo_adap_VLD1_AMBA_AXIBus_LT1_wrIF0.attach(&engine);
