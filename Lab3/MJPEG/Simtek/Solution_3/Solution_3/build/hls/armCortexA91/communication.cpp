...
#define PIC_BASE_ADDRESS 0x41006000
...
#define STDOUT_BASE_ADDRESS 0x41005000
unsigned long m_stdout_address = STDOUT_BASE_ADDRESS;
#define STDIN_BASE_ADDRESS 0x41005000
...
const unsigned long m_semaphore_count = 11;
__attribute__ ((aligned (8))) unsigned char m_stacks[0];
void* m_semaphores[11];
