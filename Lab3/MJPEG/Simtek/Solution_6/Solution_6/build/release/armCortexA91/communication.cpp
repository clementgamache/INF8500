...
#define PIC_BASE_ADDRESS 0x41004000
...
#define STDOUT_BASE_ADDRESS 0x41003000
unsigned long m_stdout_address = STDOUT_BASE_ADDRESS;
#define STDIN_BASE_ADDRESS 0x41003000
...
const unsigned long m_semaphore_count = 16;
__attribute__ ((aligned (8))) unsigned char m_stacks[0];
void* m_semaphores[16];
EntryClass m_class_entries[6];
