...
void VLD::thread(void)
{
 ...
 ModuleRead_20TO14_68(14, SPACE_BLOCKING, &nbHuff);

   // Boucle
 while(1)
 {
  // Read the command
  ModuleRead_20TO14_74(14, SPACE_BLOCKING, &uiCommand);
  ...
  if (uiCommand == 1)
  {
   ...
   do
    ...
    ModuleRead_20TO14_88(14, SPACE_BLOCKING, &magic);
      ...
      // Image number
   ModuleRead_20TO14_103(14, SPACE_BLOCKING, &rx_picture_no);

      if ( rx_picture_no != picture_no )
          picture_no = rx_picture_no;

   // Get SOF info from Demux
   ModuleRead_20TO14_109(14, SPACE_BLOCKING, &x_size);
   ModuleRead_20TO14_110(14, SPACE_BLOCKING, &y_size);
   ModuleRead_20TO14_111(14, SPACE_BLOCKING, &nb_comp);

   for(unsigned int comp_cnt = 0; comp_cnt < nb_comp; ++comp_cnt)
   {
    ModuleRead_20TO14_115(14, SPACE_BLOCKING, &HiVi[comp_cnt]);
   }
   ...
   ModuleRead_20TO14_125(14, SPACE_BLOCKING, &uiHasTable);
   ...
   if (uiHasTable == 3)
   {
    ...
    for(i = 0; i < nbHuff; i++)
    {
     ...
     if (i < nbHuff-1)
     {
      ModuleRead_20TO14_137(14, SPACE_BLOCKING, &uiHasTable);
     }
    }
   }
  }
  ...
  {
   // Skip 2 bytes
   ModuleRead_20TO14_151(14, SPACE_BLOCKING, &nothing);
   ModuleRead_20TO14_152(14, SPACE_BLOCKING, &nothing);

   ModuleRead_20TO14_154(14, SPACE_BLOCKING, &tmp);
   ModuleRead_20TO14_155(14, SPACE_BLOCKING, &cmp);
   ModuleRead_20TO14_156(14, SPACE_BLOCKING, &tmp);
   ...
   {
    // Second component
    ModuleRead_20TO14_164(14, SPACE_BLOCKING, &cmp);
    ModuleRead_20TO14_165(14, SPACE_BLOCKING, &tmp);

    compCb.DC_HT = ((tmp)>>4);
    compCb.AC_HT = ((tmp)&15);

    // Third component
    ModuleRead_20TO14_171(14, SPACE_BLOCKING, &cmp);
    ModuleRead_20TO14_172(14, SPACE_BLOCKING, &tmp);
   ...
   // Skip 3 bytes;
   ModuleRead_20TO14_179(14, SPACE_BLOCKING, &nothing);
   ModuleRead_20TO14_180(14, SPACE_BLOCKING, &nothing);
   ModuleRead_20TO14_181(14, SPACE_BLOCKING, &nothing);
...
unsigned int VLD::bitreader_get(bitreader_context *cont, int number)
{
 ...
 while (number)
   ...
   ;
         unsigned int value;
   ModuleRead_20TO14_255(14, SPACE_BLOCKING, &value);
   //SpacePrint("value : %d\n", value);
   ;
   cont->current = value;
            cont->available = 8;
...
unsigned char VLD::bitreader_get_one(bitreader_context *cont)
{
  ...
  ModuleRead_20TO14_304(14, SPACE_BLOCKING, &value);
  //SpacePrint("value : %d\n", value);
  ;
...
unsigned char VLD::read_8_bits()
{
 ...
 {
  eSpaceStatus eStatus = DeviceRead_20TO11_415(11, m_uiOffset & 0xFFFFFFFC, &m_Buffer[0], 4);
...
int VLD::huff_load_tables(huff_context *cont)
{
 ...
 ModuleRead_20TO14_445(14, SPACE_BLOCKING, &m_uiOffset);
...
void VLD::vld_decode_unpack_block( bitreader_context *bits, char mustOutput, huff_context *huff, cd_t *comp)
{
 ...
 ModuleWrite_20TO17_630(17, SPACE_BLOCKING, &T[0], (8*8));
}