...
int sc_main(int arg_count, char **arg_value){
	...
	TFMasterAdapter M_TFMasterAdapter4("M_TFMasterAdapter4", 10, SC_NS, IQZZ_ID, false);
	TFSlaveAdapter S_TFSlaveAdapter1("S_TFSlaveAdapter1", 10, SC_NS, REGISTERS_ID, false);
	TFSlaveAdapter S_TFSlaveAdapter10("S_TFSlaveAdapter10", 10, SC_NS, DEBUGMODULE1_ID, false);
	...
	TFSlaveAdapter S_TFSlaveAdapter7("S_TFSlaveAdapter7", 10, SC_NS, IQZZ_ID, false);
	TFSlaveAdapter S_TFSlaveAdapter8("S_TFSlaveAdapter8", 10, SC_NS, ISSADAPTER1_ID, false);
	TFSlaveAdapter S_TFSlaveAdapter9("S_TFSlaveAdapter9", 10, SC_NS, SIMULATION_TIMER_ID, false);
	...
	SDLRegister DL_DEMUX1_TO_IQZZ1_SDLRegister1("DL_DEMUX1_TO_IQZZ1_SDLRegister1", DL_DEMUX1_TO_IQZZ1_SDLREGISTER1_ID, 64, false);
	...
	ModuleSlaveAdapterFIFORead fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3("fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3", FIFO_ADAP_DEMUX1_AMBA_AXIBUS_LT1_RDIF3_ID, 64, false);
	...
	sc_core::sc_signal< bool > sfifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3_IRQHasDataOutPort0;
	...
	DEMUX1.SpaceModuleWriteIFPort[1](DL_DEMUX1_TO_IQZZ1_SDLRegister1.SpaceModuleWriteIFExport);
	DEMUX1.SpaceModuleWriteIFPort[2](fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF2.SpaceModuleWriteIFExport);
	DEMUX1.SpaceModuleWriteIFPort[3](fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3.SpaceModuleWriteIFExport);
	...
	IQZZ1.SpaceModuleReadIFPort[0](DL_DEMUX1_TO_IQZZ1_SDLRegister1.SpaceModuleReadIFExport);
	...
	adap_DEMUX1_AMBA_AXIBus_LT1_rdIF.FifoIFPort[0](fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF2.FifoIFExport);
	adap_DEMUX1_AMBA_AXIBus_LT1_rdIF.FifoIFPort[1](fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3.FifoIFExport);
	adap_IDCT1_AMBA_AXIBus_LT1_rdIF.FifoIFPort[0](fifo_adap_IDCT1_AMBA_AXIBus_LT1_rdIF0.FifoIFExport);
	adap_IQZZ1_AMBA_AXIBus_LT1_wrIF.FifoIFPort[0](fifo_adap_IQZZ1_AMBA_AXIBus_LT1_wrIF1.FifoIFExport);
	...
	S_TFSlaveAdapter6.SlaveIFPort(adap_IDCT1_AMBA_AXIBus_LT1_rdIF);
	S_TFSlaveAdapter7.SlaveIFPort(adap_IQZZ1_AMBA_AXIBus_LT1_wrIF);
	S_TFSlaveAdapter8.SlaveIFPort(ISSAdapter1);
	S_TFSlaveAdapter9.SlaveIFPort(simulation_timer1);
	S_TFSlaveAdapter10.SlaveIFPort(DebugModule1);
	...
	adap_IQZZ1.ChannelIFPort(M_TFMasterAdapter4);
	...
	fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3.IRQHasDataOutPort(sfifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3_IRQHasDataOutPort0);
	...
	DL_DEMUX1_TO_IQZZ1_SDLRegister1.nResetPort(reset_signal);
	...
	fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3.nResetPort(reset_signal);
	...
	XilinxPIC1.IRQInPort[2](sfifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF2_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[3](sISSAdapter1_FIFO_1_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[4](sfifo_adap_IDCT1_AMBA_AXIBus_LT1_rdIF0_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[5](sISSAdapter1_FIFO_0_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[6](sfifo_adap_DEMUX1_AMBA_AXIBus_LT1_wrIF1_IRQHasRoomOutPort0);
	XilinxPIC1.IRQInPort[7](sISSAdapter1_FIFO_1_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[8](sfifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3_IRQHasDataOutPort0);
	XilinxPIC1.IRQInPort[9](sfifo_adap_IQZZ1_AMBA_AXIBus_LT1_wrIF1_IRQHasRoomOutPort0);
	...
	DL_DEMUX1_TO_IQZZ1_SDLRegister1.attach(&engine);
	...
	fifo_adap_DEMUX1_AMBA_AXIBus_LT1_rdIF3.attach(&engine);
